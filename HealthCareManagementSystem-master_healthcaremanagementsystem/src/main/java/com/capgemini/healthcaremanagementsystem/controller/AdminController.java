...
import com.capgemini.healthcaremanagementsystem.dto.TestDto;
...
public class AdminController {
	...
	public ResponseEntity<Boolean> deletetTest(@PathVariable("id") Long testId) {
	...
	public ResponseEntity<List<DiagnosticCenter>> viewAllDiagnosticCenter() {
