...
public class GlobalErrorHandler {
	...
	@ExceptionHandler(DiagnosticCenterNotExistsException.class)
	...
	{
	//TO handle Customer name already exist
	}
	...
	{
		//TO handle Appointment not found
	}	
	
	@ResponseStatus(code = HttpStatus.ALREADY_REPORTED,reason = "Diagnosticenter already exists")
	@ExceptionHandler(CenterAlreadyExistException.class)
	public void handleCenterAlreadyExistException()
	{
		//TO handle Diagnosti Center already exists
	}
	
	@ResponseStatus(code = HttpStatus.NOT_FOUND,reason = "Diagnosticenter not found")
